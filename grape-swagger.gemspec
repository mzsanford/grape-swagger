...
Gem::Specification.new do |s|
  ...
  s.authors = ["Tim Vandecasteele", "Matt Sanford"]
  s.date = "2012-08-17"
  ...
  s.email = ["tim.vandecasteele@gmail.com", "matt@mzsanford.com"]
  s.extra_rdoc_files = [
    "LICENSE.txt",
    "README.markdown"
  ]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<mzsanford-grape>, ["~> 3.0.0.pre.2"])
      ...
      s.add_dependency(%q<mzsanford-grape>, ["~> 3.0.0.pre.2"])
